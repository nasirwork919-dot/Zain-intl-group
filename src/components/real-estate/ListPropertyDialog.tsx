...
import { Building2, CheckCircle2, Home, Image as ImageIcon, MapPin, Phone, Send, User } from "lucide-react";
...
type PropertyType = "apartment" | "villa" | "townhouse" | "penthouse" | "office" | "other";
...
export function ListPropertyDialog({
  ...
  whatsappNumber?: string; // E.164 without spaces is best
}) {
  ...
  const [furnishing, setFurnishing] = useState<"furnished" | "unfurnished" | "partly">("unfurnished");
  const [availability, setAvailability] = useState<"ready" | "vacant" | "tenanted" | "off-plan">("ready");
  ...
  const submitToWhatsApp = () => {
    ...
    const lines: string[] = [
      ...
      `• Beds: ${beds}`,
      `• Baths: ${baths}`,
      areaFormatted ? `• Area: ${areaFormatted} sqft` : (areaSqft.trim() ? `• Area: ${areaSqft.trim()}` : ""),
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          "max-w-3xl overflow-hidden rounded-[5px] p-0",
          "border border-white/40 bg-white/80 shadow-[0_30px_100px_-70px_rgba(15,23,42,0.8)]",
        ...
        <div className="grid md:grid-cols-5">
          ...
          <div className="md:col-span-3">
            <div className="p-5 sm:p-6">
              <DialogHeader>
                <DialogTitle className="text-left text-2xl font-extrabold tracking-tight">
                  List your property
                </DialogTitle>
              </DialogHeader>
              ...
              <div className="grid gap-5">
                ...
                <div className="grid gap-3">
                  ...
                  <div className="text-xs font-semibold text-muted-foreground">
                    Tip: provide either a valid phone/WhatsApp or email so we can confirm details quickly.
                  </div>
                </div>
          ...
          <div className="md:col-span-2">
            <div className="h-full border-t border-black/5 bg-[hsl(var(--page))] md:border-l md:border-t-0">
              <div className="p-5 sm:p-6">
                ...
                <div className="mt-5 text-xs font-semibold text-muted-foreground">
                  Prefer not to use WhatsApp? Tell me and I can make this send an email instead.
                </div>
              </div>
            </div>
          </div>
